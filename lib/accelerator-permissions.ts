...
export const ACCELERATOR_ROLE_DESCRIPTIONS: Record<AcceleratorRole, string> = {
  OWNER:
    "Full access to all features including team management, billing, and deletion.",
  PROGRAM_MANAGER:
    "Manages cohorts, startups, KPIs, and hub reporting. Can flag startups.",
  OPERATIONS_LEAD:
    "Manages events, curriculum, and logistics. Can view startup details.",
  MENTOR: "View-only access to assigned startups to provide guidance.",
  OBSERVER:
    "Read-only access to metrics and startup progress for stakeholders.",
};
